...
/** Category of additions for `<MSDatabase>` class.
...
@interface MSDatabase (MSDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `MSDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `MSResultSet` of schema; `nil` on error.
